...
class Vamtam_Customize_Typography_Control extends Vamtam_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['l10n'] = array(
			'font-family'                => esc_html__( 'Font Family', 'jolie' ),
			'select-font-family'         => esc_html__( 'Select Font Family', 'jolie' ),
			'font-weight'                     => esc_html__( 'Weight', 'jolie' ),
			'transform'                  => array (
				'label'        => esc_html__( 'Transform', 'jolie' ),
				'uppercase'    => esc_html__( 'Uppercase', 'jolie' ),
				'lowercase'    => esc_html__( 'Lowercase', 'jolie' ),
				'capitalize'   => esc_html__( 'Capitalize', 'jolie' ),
				'normal'       => esc_html__( 'Normal', 'jolie' ),
			),
			'font-style'                 => array (
				'label'        => esc_html__( 'Style', 'jolie' ),
				'normal'       => esc_html__( 'Normal', 'jolie' ),
				'italic'       => esc_html__( 'Italic', 'jolie' ),
				'oblique'      => esc_html__( 'Oblique', 'jolie' ),
			),
			'decoration'                 => array (
				'label'        => esc_html__( 'Decoration', 'jolie' ),
				'underline'    => esc_html__( 'Underline', 'jolie' ),
				'overline'     => esc_html__( 'Overline', 'jolie' ),
				'line-through' => esc_html__( 'Line Through', 'jolie' ),
				'none'         => esc_html__( 'None', 'jolie' ),
			),
			'font-size'                  => esc_html__( 'Font Size', 'jolie' ),
			'line-height'                => esc_html__( 'Line Height', 'jolie' ),
			'color'                      => esc_html__( 'Font Color', 'jolie' ),
			'letter-spacing'             => esc_html__( 'Letter Spacing', 'jolie' ),
			'letter-spacing-description' => wp_kses( __( 'Either <code>normal</code> or a length unit', 'jolie' ), [ 'code' => [] ] ),
		);
	}
	/**
